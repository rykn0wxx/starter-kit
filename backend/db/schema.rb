...
ActiveRecord::Schema.define(version: 2019_06_11_045419) do

  create_table "boards", force: :cascade do |t|
    t.string "board_name", limit: 50, default: "", null: false
  ...
  create_table "cards", force: :cascade do |t|
    t.string "card_name", limit: 50, default: "", null: false
  ...
  create_table "lists", force: :cascade do |t|
    t.string "list_name", limit: 50, default: "", null: false
